...
<div class="right w-full h-12">
    ...
    <div class="relative text-gray-300 w-80 p-5 pb-0 mr-16">
        ...
        <input type="search" name="search" placeholder="Search Twitter" class="bg-blue-600 h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none bg-purple-white shadow rounded border-0">
    ...
    <div class="max-w-sm rounded-lg bg-blue-600 overflow-hidden shadow-lg m-4 mr-20">
        <div class="flex">
...
<div class="flow-root m-6 inline">
    ...
    export default {
      ...
      data() {
        return {
          description: 'Ceci est un composant Vue avec une fonction data.'
        };
      }
    };
    </script>
