<template>
  <div class="border border-gray-600 h-auto border-t-0 w-full">
    <!--middle wall-->
            ...
            <navbar-app/>   
                ...
                <div class="flex">
                    <div class="m-2 w-10 py-1">
                        <img class="inline-block h-10 w-10 rounded-full" src="https://i0.wp.com/fleurdelangle.fr/wp-content/uploads/2023/08/IMG_8694-scaled.jpg?fit=1000%2C1000&ssl=1" alt="" />
                    </div>
            ...
            <div class="flex flex-shrink-0 p-4 pb-0">
                <a href="#" class="flex-shrink-0 group block">
                  <div class="flex items-center">
                    <div>
                      <img class="inline-block h-10 w-10 rounded-full" src="https://pbs.twimg.com/profile_images/1808458389720039424/4RNh3G2X_400x400.jpg" alt="" />
                    </div>
                    <div class="ml-3">
            ...
            <div class="pl-16">
                <p class="text-base width-auto font-medium text-white flex-shrink">
                  ...
                  ✍️ L'actualité en temps réel (pense à activer la 🔔 pour ne rien manquer) • 📩 Contact pro : alertesinfospro@gmail.com.<span class="text-blue-400">#tailwindcss</span>, so just started building Twitter  UI using Tailwind and so far it looks so promising. I will post my code after completion.
                  [07/100]
              ...
              <div class="flex flex-shrink-0 p-4 pb-0">
                <a href="#" class="flex-shrink-0 group block">
                  <div class="flex items-center">
                    <div>
                      <img class="inline-block h-10 w-10 rounded-full" src="https://pbs.twimg.com/profile_images/1525306536960135168/xvoXBjb5_400x400.jpg" alt="" />
                    </div>
                    <div class="ml-3">
                      <p class="text-base leading-6 font-medium text-white">
                        (Little) Think Tank
            ...
            <div class="pl-16">
                <p class="text-base width-auto font-medium text-white flex-shrink">
                  Day 07 of the challenge <span class="text-blue-400">#100DaysOfCode</span> 
                  🔴 Compte indépendant destiné au partage de l'actualité dans divers domaines

<span class="text-blue-400">#tailwindcss</span>, so just started building Twitter  UI using Tailwind and so far it looks so promising. I will post my code after completion.
                  [07/100]
                  <span class="text-blue-400"> #WomenWhoCode #CodeNewbie</span>
                </p>

                <div class="md:flex-shrink pr-6 pt-3">
                    <img class="rounded-lg w-full h-64" src="https://pbs.twimg.com/media/GSnvkSCWYAAc-eq?format=jpg&name=360x360" alt="Woman paying for a purchase">
                  </div>
                <div class="flex">
                    <div class="w-full">
